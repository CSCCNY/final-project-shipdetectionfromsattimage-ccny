...
from tensorflow.keras.layers import Input, Conv2D, MaxPooling2D, Layer, TimeDistributed, Flatten, Dense, Dropout
...
output_weight_path = os.path.join(base_path, 'model/model_weights/model_frcnn_vgg.hdf5')

record_path = os.path.join(base_path, 'model/stat/record.csv') # Record data (used to save the losses, classification accuracy and mean average precision)

base_weight_path = os.path.join(base_path, 'model/model_weights/vgg16_weights_tf_dim_ordering_tf_kernels.h5')

config_output_filename = os.path.join(base_path, 'model/model_weights/model_vgg_config.pickle')
